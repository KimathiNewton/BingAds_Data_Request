...
RESULT_FILE_NAME= 'result_' + date + '.' + 'json'
...
def download_report(reporting_download_parameters):
    ...
    json_file_path = FILE_DIRECTORY + 'result_' + date + '.json'
...
def get_report_request(account_id):
    ...
    # For different times
    #https://learn.microsoft.com/en-us/advertising/reporting-service/reporttimeperiod?view=bingads-13
    time.PredefinedTime='LastThreeMonths'
